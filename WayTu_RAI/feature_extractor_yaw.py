...
if __name__ == '__main__':
    file_out = open("logs/feature_extractor_log_distractor.txt", "w")
    parameters = {
        "dataset-path":    "Datasets/distractor-object-dataset",  # "Datasets/quaternion-object-dataset",
        ...
        "out_dim":         128,
        "regress-yaw":     True,
        "save_path" :      "small-pointner-encoder-distractor"
    }
